...
import com.example.startproject.local_utils.NetHeaders;
...
import static com.example.startproject.local_utils.NetworkUtils.isNetworkConnected;
...
//                .addInterceptor(cacheInterceptor(Application07.getAppContext()))
//                .addNetworkInterceptor(cacheInterceptor(Application07.getAppContext()))
